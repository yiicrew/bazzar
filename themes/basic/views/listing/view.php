...
<section class="listing-view">
    <header class="card listing-view__header">
        <div class="card-block">
            <div class="listing-action pull-lg-right">
                <a href="#" class="listing-action__link">
                    <span class="listing-action__icon glyphicon glyphicon-heart-empty"></span> Watch
                </a>
                <a href="#" class="listing-action__link">
                    <span class="listing-action__icon glyphicon glyphicon-duplicate"></span> Post a similar ad
                </a>
            </div>

            <h1 class="listing-view__title"><?= e($listing->title) ?></h1>
            <!-- @TODO: move price check to listing model -->
    ...
    <div class="row">
        <div class="listing-view__content col-lg-8">
            ...
            <div class="card m-b-3 listing-view__description">
                <div class="card-block">
        ...
        <div class="listing-view__sidebar col-lg-4">
            <div class="clearfix m-b-1">
                <div class="report pull-lg-right">
            ...
            <div class="card card--user">
                <div class="card-block">
                    ...
                    <div class="user clearfix">
                        <div class="user__media pull-lg-left">
                            <span class="user__icon"></span>
                        </div>
                        <div class="user__info pull-lg-left">
                    ...
                    <?php endif ?>
                    <div class="reply">
                        <a href="#" class="btn btn-primary btn-lg u-block">Send Message</a>
                        <?php if ($listing->user): ?>
                        <a href="#">
            ...
            <div class="safety clearfix">
                <div class="safety__media pull-lg-left">
